            ...
            <Form className={cx("modalBody")}>
              ...
              <Row className={cx("mb-4")}>
                ...
                <Form.Group as={Col}>
                  ...
                  <Form.Control type="text" defaultValue={data?.candidate?.workMode} readOnly />
                </Form.Group>
              </Row>
              <Row>
                <Form.Group as={Col}>
                  ...
                  <Form.Control
                    type="text"
                    defaultValue={data?.assessments[0]?.interviewer?.name}
                    readOnly
                  />
                </Form.Group>
                <Form.Group as={Col}>
                  ...
                  <Form.Control
                    type="text"
                    defaultValue={data?.assessments[1]?.interviewer?.name}
                    readOnly
                  />
                </Form.Group>
                <Form.Group as={Col}>
